let properties = [
  {
    ...
    images: [
      "https://via.placeholder.com/400x300?text=Bungalow+1-1",
      "https://via.placeholder.com/400x300?text=Bungalow+1-2",
      "https://via.placeholder.com/400x300?text=Bungalow+1-3"
    ],
    model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb",
    position: { lat: 37.7749, lng: -122.4194 },
    price: "$2,500,000",
    description: "A luxurious bungalow with modern amenities.",
    area: "2500 sqft",
    rates: "6% commission",
    sellerContact: "contact@bungalow1.com"
  },
  {
    id: 2,
    title: "Cozy Bungalow",
    images: [
      "https://via.placeholder.com/400x300?text=Bungalow+2-1",
      "https://via.placeholder.com/400x300?text=Bungalow+2-2",
      "https://via.placeholder.com/400x300?text=Bungalow+2-3"
    ],
    model3d: "https://modelviewer.dev/shared-assets/models/RobotExpressive.glb",
    position: { lat: 37.8044, lng: -122.2711 },
    price: "$1,800,000",
    description: "A cozy bungalow perfect for families.",
    area: "1800 sqft",
    rates: "5% commission",
    sellerContact: "contact@bungalow2.com"
  }
];
