let properties = [
  {
    ...
    images: [
      "https://via.placeholder.com/400x300?text=Flat+1-1",
      "https://via.placeholder.com/400x300?text=Flat+1-2",
      "https://via.placeholder.com/400x300?text=Flat+1-3"
    ],
    model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb",
    position: { lat: 37.7749, lng: -122.4194 },
    price: "$900,000",
    description: "A modern flat in the city center.",
    area: "1100 sqft",
    rates: "5% commission",
    sellerContact: "contact@flat1.com"
  },
  {
    id: 2,
    title: "Suburban Flat",
    images: [
      "https://via.placeholder.com/400x300?text=Flat+2-1",
      "https://via.placeholder.com/400x300?text=Flat+2-2",
      "https://via.placeholder.com/400x300?text=Flat+2-3"
    ],
    model3d: "https://modelviewer.dev/shared-assets/models/RobotExpressive.glb",
    position: { lat: 37.8044, lng: -122.2711 },
    price: "$750,000",
    description: "A cozy flat in the suburbs.",
    area: "950 sqft",
    rates: "4% commission",
    sellerContact: "contact@flat2.com"
  }
];
